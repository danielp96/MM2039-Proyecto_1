...
A_reg = exp(Sol(1)); %Obtención de constantes de laa regresion
k_reg = Sol(2);

y_reg = A_reg*exp(k_reg*x).*(-cos(2*pi*f_reg*x)); %funcion obtenida de la regresión
...
figure(3)
step(5*G) %Se grafica la respuesta al escalón de 5V de la función de transferencia
